  ...
  return (
    ...
    <section className="slider-area">
        <div className="slider-active slick-initialized slick-slider slick-dotted">
            <div className="single-slider slider-bg" data-background="img/slider/slider_bg01.jpg">
                <div className="container">
                    <div className="row">
                    <div className="col-lg-7">
                        <div className="slider-content" data-animation="fadeInUp" data-delay=".2s">
            ...
            <div className="single-slider slider-bg" data-background="img/slider/slider_bg02.jpg">
                <div className="container">
                    <div className="row">
                    <div className="col-lg-7">
                        <div
