...
export default function HistoryArea() {
  return (
    <>
    <section className="history-area history-bg has-animation jarallax" data-background="img/bg/history_bg.jpg">
        <div className="container">
            ...
            <div className="row history-active">
                ...
                <div className="history-item">
                    ...
                    <h2 className="title">We already branches across the country</h2>
                    <p>
                        Lorem dolor consectetur tellus suspendisse nulla aliquam at the
                        ultrices the pretium
                    </p>
                    </div>
                </div>
                </div>
                ...
                <div className="history-item">
                    ...
                    <div className="history-content">
                    <h2 className="title">Cleaning Authority for a Free Estimate</h2>
                    <p>
                        Lorem dolor consectetur tellus suspendisse nulla aliquam at the
                        ultrices the pretium
                    </p>
